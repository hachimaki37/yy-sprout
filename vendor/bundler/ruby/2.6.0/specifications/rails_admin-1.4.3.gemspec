# -*- encoding: utf-8 -*-
# stub: rails_admin 1.4.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<font-awesome-rails>.freeze, [">= 3.0", "< 5"])
      ...
      s.add_runtime_dependency(%q<sass-rails>.freeze, [">= 4.0", "< 6"])
      s.add_development_dependency(%q<bundler>.freeze, ["~> 1.0"])
    else
      s.add_dependency(%q<builder>.freeze, ["~> 3.1"])
      s.add_dependency(%q<coffee-rails>.freeze, ["~> 4.0"])
      s.add_dependency(%q<font-awesome-rails>.freeze, [">= 3.0", "< 5"])
      ...
      s.add_dependency(%q<sass-rails>.freeze, [">= 4.0", "< 6"])
